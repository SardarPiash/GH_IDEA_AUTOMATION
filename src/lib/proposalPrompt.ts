...
Use EVERY non-empty field below. Do not invent names, dates, benefits, impact, URLs, examples, or extra claims that are not in the input. If a field is empty, omit it from the document — do not guess. Keep the submitter's meaning. Clean and organize the wording only. Length: medium — not a one-liner, not a long essay. Write in the same language as the idea details.
